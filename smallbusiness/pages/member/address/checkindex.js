...
Page({
  ...
  checkaddress(e){
    ...
    console.log(e)
    let locationInfo = {}
    locationInfo.address = e.currentTarget.dataset.item.addr
    locationInfo.lat = e.currentTarget.dataset.item.lat
    locationInfo.lng = e.currentTarget.dataset.item.lng
    app.setCache('locationInfo',locationInfo)
    app.setCache("latitude",e.currentTarget.dataset.item.lat,86400),app.setCache("longitude",e.currentTarget.dataset.item.lng,86400)
    wx.navigateBack({
      delta: 1,
    })
  }
