var r = require("../utils/interopRequireDefault")(require("../utils/typeof")), n = {}, t = [], e = t.push, i = t.indexOf, o = n.toString, u = n.hasOwnProperty, a = "1.10.2".trim, f = /%20/g, l = /\[\]$/, c = {
    ...
    toFixed: function(r, n) {
        var t = parseInt(n) || 0;
        if (t < -20 || 100 < t) throw new RangeError("Precision of " + t + " fractional digits is out of range");
        var e = Number(r);
        ...
        var c = i.length;
        (c <= t && (i = Math.pow(10, t + 1 - c).toString().substring(1) + i, c = t + 1), 
        0 < t) && (i = i.substring(0, c - t) + "." + i.substring(c - t));
        return o + i;
    }
};
...
function s(e, n, i, o) {
    var t;
    if (c.isArray(n)) c.each(n, function(n, t) {
        i || l.test(e) ? o(e, t) : s(e + "[" + ("object" === (0, r.default)(t) ? n : "") + "]", t, i, o);
    }); else if (i || "object" !== c.type(n)) o(e, n); else for (t in n) s(e + "[" + t + "]", n[t], i, o);
}

function p(r) {
    var n = r.length, t = c.type(r);
    return !c.isWindow(r) && (!(1 !== r.nodeType || !n) || "array" === t || "function" !== t && (0 === n || "number" == typeof n && 0 < n && n - 1 in r));
}
...
c.extend = function() {
    ...
    a !== (i = n[t]) && (s && i && (c.isPlainObject(i) || (o = c.isArray(i))) ? (u = o ? (o = !1, 
    e && c.isArray(e) ? e : []) : e && c.isPlainObject(e) ? e : {}, a[t] = c.extend(s, u, i)) : void 0 !== i && (a[t] = i));
    return a;
